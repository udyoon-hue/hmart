  ...
  return (
    ...
    >     
      ...
      <View>
        ...
        <Text style={{ color: pathname == "/activity/follows" ? "red" : "black"}}>
          Follows
        </Text>
        </TouchableOpacity>
      </View>
      <View>
        <TouchableOpacity onPress={() => router.replace(`/activity/replies`)}>
          <Text style={{ color: pathname == "/activity/replies" ? "red" : "black"}}>
            Replies
          </Text>
        </TouchableOpacity>
      </View>
      <View>
        ...
        <Text style={{ color: pathname == "/activity/mentions" ? "red" : "black"}}>
          Mentions
        </Text>
        </TouchableOpacity>
      </View>
      <View>
        ...
        <Text style={{ color: pathname == "/activity/quotes" ? "red" : "black"}}>
          Quotes
        </Text>
        </TouchableOpacity>
      </View>
      <View>
        ...
        <Text style={{ color: pathname == "/activity/reposts" ? "red" : "black"}}>
          Reposts
        </Text>
        </TouchableOpacity>
      </View>
      <View>
        ...
        <Text style={{ color: pathname == "/activity/verified" ? "red" : "black"}}>
          Verfied
        </Text>
        </TouchableOpacity>
      </View>
