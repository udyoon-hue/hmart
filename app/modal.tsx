...
export default function Modal() {
  ...
  //const updateThreadText = (id: string, text: string) => {}; 글자 입력 현재는 입력 안됨
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      {/* *renderItem={renderThreadItem} 위쪽 아이콘, zerohcho inputText 사진 위치정보
       * ListFooterComponent={ 이부분은 add to thread부분 
       * keyboardShouldPersistTaps="handled" inputText에서 입력하고 키보스를 다른공백을 누르면 사라지게 만든다
       */}
      <FlatList
        data={threads}
      ...
      {/**postButtonDisabled post버튼 비활성화 */}
